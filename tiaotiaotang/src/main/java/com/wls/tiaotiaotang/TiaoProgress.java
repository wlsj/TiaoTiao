...
public class TiaoProgress extends View {
    ...
    public TiaoProgress(Context context) {
        super(context);
        init(context);
    }

    public TiaoProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TiaoProgress(Context context, AttributeSet attrs, int defStyleAttr) {
